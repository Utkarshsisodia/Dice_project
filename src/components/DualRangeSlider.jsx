    ...
    <div className="w-full relative mt-10 touch-none select-none">
      ...
      <div className="relative w-full h-[44px] bg-[#2f4553] rounded-full shadow-sm">
        <div className="absolute inset-y-0 left-[22px] right-[22px]">
          ...
          <div
            ref={trackRef}
            className="absolute top-[18px] left-0 right-0 h-[8px] rounded-full"
          >
            ...
            >
              <div
                className={`absolute bottom-[85px] left-1/2 -translate-x-1/2 bg-[#364c59] px-3 py-1.5 rounded text-sm font-bold text-white shadow-xl pointer-events-none transition-all duration-200 ease-out z-30
                ${dragging === "left" ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3 group-hover:opacity-100 group-hover:translate-y-0"}`}
              >
                {minVal.toFixed(2)}
            ...
            >
              <div
                className={`absolute bottom-[85px] left-1/2 -translate-x-1/2 bg-[#364c59] px-3 py-1.5 rounded text-sm font-bold text-white shadow-xl pointer-events-none transition-all duration-200 ease-out z-30
                ${dragging === "right" ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3 group-hover:opacity-100 group-hover:translate-y-0"}`}
              >
                {maxVal.toFixed(2)}
                <div className="absolute top-full left-1/2 -translate-x-1/2 border-l-[6px] border-r-[6px] border-t-[6px] border-transparent border-t-[#364c59]"></div>
              </div>
